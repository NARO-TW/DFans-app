...
describe 'Test Service Objects' do
  ...
  describe 'Find authenticated account' do
    it 'HAPPY: should find an authenticated account' do
      ...
      auth = DFans::AuthenticateAccount.new.call(**@credentials)
    ...
    it 'BAD: should not find a false authenticated account' do
      ...
      _(proc {
        DFans::AuthenticateAccount.new.call(**@mal_credentials)
      }).must_raise DFans::AuthenticateAccount::NotAuthenticatedError
    end
  end
end
